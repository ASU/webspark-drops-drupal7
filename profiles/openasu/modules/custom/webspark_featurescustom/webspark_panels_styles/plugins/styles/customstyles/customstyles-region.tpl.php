...
<div class="customstyles-region  <?php print $classes; ?> <?php print (isset($settings['fullwidthbg'])) ? $settings['fullwidthbg'] : ''; ?> <?php print (isset($settings['panerowpad'])) ? $settings['panerowpad'] : ''; ?> <?php print (isset($settings['panespace'])) ? $settings['panespace'] : ''; ?>">
