 ...
 */
function asu_webspark_bootstrap_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['theme_configuration']['default_picture'] = array(
    ...
    '#default_value' => theme_get_setting('default_picture', 'asu_webspark_bootstrap'),
    '#tree' => FALSE,
  ...
  $form['theme_configuration']['settings']['picture_path'] = array(
    ...
    '#default_value' => theme_get_setting('picture_path', 'asu_webspark_bootstrap'),
  );
  ...
  $form['#submit'][] = 'asu_webspark_bootstrap_settings_submit';
  $form['#validate'][] = 'asu_webspark_bootstrap_settings_validate';
}
