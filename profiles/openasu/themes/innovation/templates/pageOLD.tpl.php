...
/**
 * @file
 * Innovation theme implementation to display a single Drupal page.
 * Taken from Bartik theme.
 *
 * The doctype, html, head, and body tags are not in this template. Instead
 * they can be found in the html.tpl.php template (normally located in the
 * core/modules/system directory, but in Kalatheme's templates directory).
 *
 * Available variables:
 *
